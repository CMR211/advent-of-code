import { draws, boards } from "./inputs/day-4-input.mjs";
...
export function sumOfUnmarkedTiles(board) {
...
export function updateSingleBoard(draw, board) {
...
export function rowSum(board, row) {
    // row from 0 to 4
    const indexes = [
        row * 5,
        row * 5 + 1,
...
export function colSum(board, col) {
    // col from 0 to 4
