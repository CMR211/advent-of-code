const { initialPopulation } = require("./input")
...
function solve6b(initialPopulation) {
    ...
    console.log(`After day 256 there will be ${demographics.reduce((a, b) => a + b)} lanternfish`)
}

function solve6a(currentState) {
    console.log(`After day ${currentState.day}: ${currentState.population.length}.`)
